...
import { V3Router } from "./v3/Routes/routes";
...
function App() {
  ...
  // Hide the global switcher on v3 — v3 has its own built-in version switcher.
  // Track pathname via state so we react properly to both initial load and SPA navigation.
  ...
  const isV3 = currentPath.startsWith("/v3");
