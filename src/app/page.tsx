    ...
    <Container className="flex flex-row h-[80vh]  items-center w-[70rem]  ">
      <Container className="flex flex-row justify-between h-1/2">
        <div className="flex flex-col justify-start items-start ">
          ...
          <label className='border-solid border-red-500 text-black'>Hello</label>
          ...
          <StyledLabel fontWeight={"bolder"} fontSize={20}>Based in Goa, India.</StyledLabel>
        ...
        /> */}
        <BiUser           className=" responsive border-2  blobby-div"
s/>
      </Container>
    </Container>
  );
