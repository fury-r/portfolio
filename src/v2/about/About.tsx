const About = () => {
  return (
    <div key="about">
      <p className=" font[1.6rem]">
        I am a skilled and experienced software engineer with a demonstrated
        track record of success in full-stack web development. With over Three
        ...
        ever-evolving tech landscape. My expertise extends beyond coding, as I
        exhibit excellent problem-solving abilities, consistently finding
        solutions to complex bugs and optimizing existing code for efficiency.
      </p>
    </div>
  );
};
