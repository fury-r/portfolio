        ...
        >
            ...
            >
                ...
                <motion.div
                    ...
                    animate="visible"
                    style={{
                        ...bentoCard({ padding: "28px 28px 24px", gridColumn: "1 / 3" }),
                        boxShadow: glassMode
                ...
                >
                    ...
                    <motion.p
                        ...
                        style={{ color: "var(--v3-text2)", fontSize: 13, marginBottom: 8, letterSpacing: 0.3 }}
                    >
                        Hi there 👋, I&apos;m
                    </motion.p>
                    <motion.h1
                    ...
                    <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
                        {[
                            { href: github, icon: <FaGithub size={15} />, label: "View GitHub", primary: true },
                            { href: linkedin, icon: <FaLinkedin size={15} />, label: "LinkedIn", primary: false },
                        ].map((btn) => (
                            <motion.a
                                key={btn.label}
                                href={btn.href}
                ...
                >
                    ...
                    <div>
                        ...
                        <p style={{ color: "var(--v3-text2)", fontSize: 12, margin: 0, lineHeight: 1.6 }}>
                ...
                <StatCell value={3} label="Years Exp" accent={accentColor} glassMode={glassMode} i={2} />
                <StatCell value={6} suffix="+" label="Projects" accent={accentColor} glassMode={glassMode} i={3} />
                <StatCell value={15} suffix="+" label="Technologies" accent={accentColor} glassMode={glassMode} i={4} />
            </div>
